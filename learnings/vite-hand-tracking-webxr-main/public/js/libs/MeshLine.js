...
;(function () {
  ...
  MeshLine = class extends THREE.BufferGeometry {
    constructor() {
      super()
  ...
  MeshLineRaycast = function (raycaster, intersects) {
  ...
  MeshLineMaterial = class extends THREE.ShaderMaterial {
  ...
  MeshLineMaterial.prototype.copy = function (source) {
    ...
    this.dashArray = source.dashArray // Direct assignment instead of copy
    this.dashOffset = source.dashOffset // Direct assignment instead of copy
    this.dashRatio = source.dashRatio // Direct assignment instead of copy
    this.useDash = source.useDash // Direct assignment instead of copy
